...
date: 2025-06-25
description: "Some of my experiences while working on mechagogue, a reinforcement learning repository with from-scratch JAX implementations of classic RL algorithms."
---
...
![Random agent playing Breakout](/blog/mechagogue-jax/breakout_rand.gif)

And here's an agent that plays a perfect policy (until the game gets too fast for it thanks to difficulty ramping):

![Perfect-policy agent playing breakout](/blog/mechagogue-jax/breakout_perfect.gif)
...
![Trained agent playing breakout, seed 3214](/blog/mechagogue-jax/breakout_5M_epochs_seed3214_sticky_ramping_1q.gif)
