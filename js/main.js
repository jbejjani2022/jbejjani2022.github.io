document.addEventListener("DOMContentLoaded", () => {
  ...
  'thing', 'thong', 'black', 'widow', 'frome', 'penne', 'treks', 'water', 'hippo', 'bathe', 'cygne',
  'sudsy', 'bones', 'hammy', 'ikeas', 'chefs', 'croak', 'rhino', 'banan', 'grego',
  ...
  'lorax', 'chimp', 'quads', 'ponds', 'stats', 'books', 'angel',
